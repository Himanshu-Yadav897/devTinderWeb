...
const Home = () => {
  ...
  return (
    <>
      {/* Landing Section */}
      <div className="bg-[#17253A] text-white min-h-screen flex flex-col-reverse md:flex-row items-center justify-center px-6 pt-10 pb-4 relative overflow-hidden">
        ...
        {/* Right Side: 3D Spline (hidden on mobile) */}
        <div className="hidden md:flex flex-1 w-full max-w-[600px] h-[400px] md:h-[600px] z-10 relative overflow-hidden">
